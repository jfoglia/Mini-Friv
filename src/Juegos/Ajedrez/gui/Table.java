...
import Juegos.Ajedrez.Engine.board.*;
import Juegos.Ajedrez.Engine.board.Move.MoveFactory;
import Juegos.Ajedrez.Engine.pieces.Piece;
import Juegos.Ajedrez.Engine.player.Player;
import Juegos.Ajedrez.Engine.player.ai.AIProgressListener;
import Juegos.Ajedrez.Engine.player.ai.StandardBoardEvaluator;
import Juegos.Ajedrez.Engine.player.ai.StockAlphaBeta;
import Juegos.Ajedrez.pgn.FenUtilities;
import Juegos.Ajedrez.pgn.MySqlGamePersistence;
import Juegos.Ajedrez.pgn.PGNUtilities;
...
public final class Table implements Game{
    ...
    private void resetGame()
    {
        ...
        Table.get().getGameHistoryPanel().redo(chessBoard, moveLog);
        Table.get().getTakenPiecesPanel().redo(moveLog);
        Table.get().getBoardPanel().drawBoard(chessBoard);
        Table.get().getDebugPanel().redo();

        // Notificar que se reinició
...
//                Table.get().getGameFrame().repaint();
    ...
    private class TilePanel extends JPanel {
        ...
        private void assignTilePieceIcon(final Board board) 
        {
            ...
            if (board.getPiece(this.tileId) != null) {
                ...
                System.out.println("Cargando imagen: " + fileName); // Para depurar
    ...
    public String getPieceIconPath()
    {
    return this.pieceIconPath;
    }
